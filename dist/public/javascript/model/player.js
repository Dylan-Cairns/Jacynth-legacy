...
export class ComputerPlayer extends Player {
  constructor(playerID, gameBoard, deck, opponentID) {
    ...
    this.computerTakeTurn = () => {
      ...
      if (
        (finalChoice === null || finalChoice === void 0
          ? void 0
          : finalChoice.withTokenScore) &&
        (finalChoice === null || finalChoice === void 0
          ? void 0
          : finalChoice.spaceToPlaceToken)
      ) {
        ...
        console.log(
          `${this.playerID} played a token to ${
            (_a = finalChoice.spaceToPlaceToken) === null || _a === void 0
              ? void 0
              : _a.getID()
          }`
        );
